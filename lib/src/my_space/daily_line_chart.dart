...
class LineChartSample5 extends StatefulWidget {
  const LineChartSample5({
    ...
    required Color gradientColor3,
    required Color indicatorStrokeColor,
...
class _LineChartSample5State extends State<LineChartSample5> {
  List<int> showingTooltipOnSpots = [0,1, 3, 5, 6];
            ...
            LineChartData(
              ...
              lineTouchData: LineTouchData(
                ...
                touchTooltipData: LineTouchTooltipData(
                  tooltipBgColor: Colors.purple.lightest,
